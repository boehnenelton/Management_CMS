...
RELATIONAL_ID:  4e9a2c7f-6b1d-4c8a-9e3f-5d2b7a4e9c14

CHANGELOG (2.0.3, 2026-07-26): Dead-code sweep. Removed unused `Set`
import from `typing` — never referenced anywhere in the file.
"""
